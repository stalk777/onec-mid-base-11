...
//   					 - см. ПодключаемыеКоманды.ПараметрыРазмещения
//
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	//НачалоДоработки
	//Воронов А.А, ДомашниеЗадание "Внесение изменений в конфигурацию на поддержке" от 06.02.2024
	//Добавление ОбщегоМодуля для доработки формы
	//
